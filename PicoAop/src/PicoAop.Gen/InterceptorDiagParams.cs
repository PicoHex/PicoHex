...
internal static class InterceptorDiagParams
{
    ...
    public static readonly DiagnosticDescriptor InterceptorTypeMismatch = new(
        "PICO010",
    ...
    public static readonly DiagnosticDescriptor FilterRequiresInterface = new(
        "PICO011",
    ...
    public static readonly DiagnosticDescriptor ZeroInterceptorsMatched = new(
        "PICO012",
    ...
    public static readonly DiagnosticDescriptor ConflictingInterceptorDeclaration = new(
        "PICO013",
    ...
    public static readonly DiagnosticDescriptor AmbiguousInterceptBy = new(
        "PICO014",
    ...
    public static readonly DiagnosticDescriptor RefLikeMethodDelegated = new(
        "PICO016",
    ...
    public static readonly DiagnosticDescriptor SealedTypeIntercepted = new(
        "PICO017",
