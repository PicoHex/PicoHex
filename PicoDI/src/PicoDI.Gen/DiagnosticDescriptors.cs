...
internal static class DiagnosticDescriptors
{
    ...
    public static readonly DiagnosticDescriptor AbstractTypeRegistration =
        new(
            "PICO003",
    ...
    public static readonly DiagnosticDescriptor MissingPublicConstructor =
        new(
            "PICO004",
    ...
    public static readonly DiagnosticDescriptor MultipleMarkedConstructors =
        new(
            "PICO005",
    ...
    public static readonly DiagnosticDescriptor GenericRegistrationOverload =
        new(
            "PICO006",
