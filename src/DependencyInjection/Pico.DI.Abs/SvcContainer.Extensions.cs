...
public static partial class SvcContainerExtensions
{
    ...
    extension(ISvcContainer registry)
    {
        public ISvcContainer Register([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]
            Type serviceType,
    ...
    extension(ISvcContainer registry)
    {
        ...
        public ISvcContainer Register<
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TService
        >(Func<ISvcProvider, TService> factory, SvcLifetime lifetime)
